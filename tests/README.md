...
| `test_render.py` | `skills/draw-diagram/scripts/render.py` | `.mmd` と SVG の id・辺の対応照合、禁止要素(`script`・`foreignObject`・`image`・外部参照)・整形式の検査、`classDiagram`/`erDiagram` の照合対象外扱い |
